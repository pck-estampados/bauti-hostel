...
export default function RoomsNowPage() {
  ...
  return (
    <>
      ...
      </div> : <EmptyState title="Sin habitaciones configuradas" description="Todavía no hay habitaciones configuradas. Completá el inventario desde Configuración." action={{ href: "/admin/configuracion#habitaciones", label: "Configurar inventario" }} />}
    </>
  );
}
