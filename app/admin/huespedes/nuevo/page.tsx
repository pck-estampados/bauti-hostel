...
export default function NewGuestPage() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) { event.preventDefault(); try { await addGuest(form); router.push("/admin/huespedes/actuales?created=guest"); } catch (caught) { setError(caught instanceof Error ? caught.message : "No fue posible registrar."); } }
